...
public class ACOTest {
  ...
  public void test(){
      ...
      arrayList1.add(new String[] {"#"});
      arrayList1.add(new String[] {"0","1","5"});
      arrayList1.add(new String[] {"0","2","4"});
      arrayList1.add(new String[] {"1","2","7"});
      ACO aCO1 = new ACO(arrayList1, 1, 1, 0.5, 1, 1);
      aCO0.antStartSearching(30);
